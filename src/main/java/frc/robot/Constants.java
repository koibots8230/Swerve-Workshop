...
public class Constants {
  ...
  public static class RobotConstants {
    ...
    public static final double ROBOT_WIDTH = edu.wpi.first.math.util.Units.inchesToMeters(26);
    public static final double ROBOT_LENGTH = edu.wpi.first.math.util.Units.inchesToMeters(26);
